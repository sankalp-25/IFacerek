...
#     if len(name):
#         frame = cv2.rectangle(frame,(bbox[0],bbox[1]),(bbox[2],bbox[3]),(0,0,25),6)
#         frame = cv2.putText(frame,name,(bbox[0],bbox[1]),cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3,cv2.LINE_AA)
#     else:
#         frame = cv2.rectangle(frame,(bbox[0],bbox[1]),(bbox[2],bbox[3]),(0,0,25),6)
#     return frame
...
def draw_box_name(bbox,name,frame):
    print("--------------------------------------",name)
    if len(name):
        frame = cv2.rectangle(frame,(bbox[0],bbox[1]),(bbox[0]+bbox[2],bbox[1]+bbox[3]),(0,0,25),6)
        frame = cv2.putText(frame,name,(bbox[0],bbox[1]),cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3,cv2.LINE_AA)
    else:
        frame = cv2.rectangle(frame,(bbox[0],bbox[1]),(bbox[0]+bbox[2],bbox[1]+bbox[3]),(0,0,25),6)
    return frame
